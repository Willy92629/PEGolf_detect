...
std = 1
swing = 3
dirpath = "0601_1/Student_1_{std}/output/json/swing{swing}/".format(std=std, swing=swing)
...
for iii in range(len(os.listdir(dirpath))-1):
    ...
    fileNumber += 1
outfile = "0601_1/Student_1_{std}/output/json/swing{swing}/result.json".format(std=std, swing=swing)
